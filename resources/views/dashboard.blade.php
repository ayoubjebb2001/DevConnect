        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="flex-grow">
                            ...
                            <div class="mt-4 space-y-4">
                                ...
                                <div class="flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    @if($user->github_url)
                                        <a href="{{ $user->github_url }}" target="_blank" class="flex items-center hover:text-gray-900 dark:hover:text-gray-100">
                                    ...
                                    @if($user->portfolio_url)
                                        <a href="{{ $user->portfolio_url }}" target="_blank" class="flex items-center hover:text-gray-900 dark:hover:text-gray-100">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="flex justify-between items-center mb-4">
                             ...
                             <div class="flex flex-wrap gap-2">
                                @forelse($user->skills as $skill)
                                    <span class="px-3 py-1 text-sm bg-gray-100 dark:bg-gray-700 rounded-full text-gray-700 dark:text-gray-300">
                                        {{ $skill->name }}
                                    </span>
                                @empty
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                        <div class="p-6">
                            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Latest Posts</h2>
